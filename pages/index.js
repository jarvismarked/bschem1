      ...
      <section className="hero-area-three">
        <Slider {...heroSliderOne} className="hero-slider-one">
          <div className="single-slider p-r z-1">
            ...
            />
            {/* <div className="brand-card dark-white-bg">
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="hero-content text-white">
                    ...
                    <p>
                      Các hóa chất thí nghiệm của chúng tôi được chế tạo tỉ mỉ
                      và kiểm tra kỹ lưỡng để đảm bảo tiêu chuẩn cao nhất về
                      chất lượng và an toàn. Chúng tôi cung cấp một loạt các hóa
                      chất cần thiết cho nghiên cứu, phân tích và các ứng dụng
                      khoa học khác nhau.
                    </p>
                    <div
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="hero-content text-white">
                    ...
                    >
                      <p>
                        Chúng tôi cung cấp danh mục toàn diện các hóa chất công
                        nghiệp, hiệu quả và thân thiện với môi trường. Các hóa
                        chất này được thiết kế để đáp ứng các yêu cầu khắt khe
                        của quy trình và ứng dụng công nghiệp, đảm bảo hiệu suất
                        tối ưu và bền vững.
                      </p>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="hero-content text-white">
                    ...
                    <p>
                      Blacksun Chemical cũng cung cấp các vật tư và thiết bị
                      hiện đại, sử dụng công nghệ mới nhất để đảm bảo quy trình
                      sản xuất hiệu quả và bền vững. Cam kết đổi mới của chúng
                      tôi thúc đẩy chúng tôi liên tục cải tiến và thích ứng với
